...
export const SKILL_TREE_V2: TreeNode[] = [
  {
    id: "overhang",
    label: "Overhang",
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            exercises: [
              ...
              },
              {
                ...
                detail: "Find problems with heel scum on the overhang · 4 problems × 3 sets",
              },
              {
          ...
          },
          {
            ...
            exercises: [
              {
                name: "Backstep Traverses",
                detail:
                  "Traverse overhanging wall using only outside edge backstep footwork · 3 laps",
              },
              {
                name: "Hip Rotation Drills",
                detail: "Exaggerate hip drop into wall on each backstep move · 10 reps",
              },
              {
                name: "Silent Backstep Practice",
                detail: "Place feet without sound on each backstep hold · 5 problems",
              },
            ],
          },
        ],
            ...
            exercises: [
              {
                ...
                detail: "Select problems using compression technique · 5 problems × 3 attempts",
              },
              {
            ...
            exercises: [
              {
                ...
                detail: "On overhang: get hip flush to wall before moving · 10 moves × 3 sets",
              },
              {
              ...
              },
              {
                ...
                detail: "3× slower on a familiar problem — notice hip position at each move",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            exercises: [
              {
                name: "Hip Over Foot Drills",
                detail: "Pause at each move — ensure hip is directly above stance foot",
              },
              {
                name: "Slow-motion Slab",
                detail: "Climb easy slab at 3× slower pace · notice weight distribution",
              },
              {
                name: "One-foot Balance Holds",
                detail: "Stand on one foot for 5s per foothold before moving",
              },
              {
                name: "Downclimbing Practice",
                detail: "Downclimb every slab route · equal reps up and down",
              },
            ],
          },
          {
            ...
            exercises: [
              ...
              },
              {
                ...
                detail: "Lead (not top-rope) slab routes — commitment becomes non-negotiable",
              },
              {
        ...
        children: [
          {
            ...
            exercises: [
              ...
              },
              {
                ...
                detail: "Practice dead pointing to crimp holds specifically · 8 reps × 3 sets",
              },
            ],
          },
          {
            ...
            exercises: [
              {
                name: "Pendulum Moves",
                detail: "Use body swing to reach holds in sequence · 5 problems set for this",
              },
              {
                name: "Campus Swing Drills",
                detail: "Generate and direct swing momentum on campus rungs · 3 sets",
              },
              {
                name: "Steep Momentum Circuits",
                detail:
                  "Climb steep routes maintaining momentum through crux sequences",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            exercises: [
              ...
              },
              {
                ...
                detail:
                  "Avoid full crimp — build open-hand strength on moderate holds",
              },
            ],
          },
          {
            ...
            exercises: [
              ...
              },
              {
                ...
                detail:
                  "Focus on pressing thumb against fingers on each pinch hold",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            exercises: [
              ...
              {
                name: "Feet-high Drill",
                detail: "Push feet up and away while pulling outward · 10 moves",
              },
          ...
          },
          {
            ...
            exercises: [
              {
                name: "Gaston Movement Drill",
                detail: "Elbow out, thumb down, push outward — 10 moves on set holds",
              },
              {
                name: "Side Pull to Gaston",
                detail: "Transition from side pull to gaston on overhang · 3 sets",
              },
              {
                name: "Shoulder External Rotation",
                detail:
                  "Band external rotation · 15 reps × 3 sets · builds gaston stability",
              },
            ],
          },
          {
